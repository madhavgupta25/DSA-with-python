#these all are the basic operation of dictionaries and they all are take constant time O(1)
...
# del capital_map["Spain"] #this give an keyError because Spain is not present in capital_map
